...
def runapp():
  ...
  app.add_url_rule(settings.API_PREFIX + '/dashboard/incasol', view_func=req_dashboard_incasol, methods=['GET'])
  ...
  app.add_url_rule(settings.API_PREFIX + '/roomsd/<int:segment>/<int:year>', view_func=req_roomsd, methods=['GET'])
  ...
  # Misc functions
  app.add_url_rule(settings.API_PREFIX + '/http/<int:code>', view_func=req_pub_http, methods=['GET'])
  ...
  app.add_url_rule(settings.API_PREFIX + '/ical/<string:token>', view_func=req_ical, methods=['GET'])
